...
# Compute the loading
Sy_v = aileron.Sy(x)               # Compute the shear force in y
Sz_v = aileron.Sz(x)               # Compute the shear force in z
My_v = aileron.My(x)               # Compute the moment around the y-axis
Mz_v = aileron.Mz(x)               # Compute the moment around the z-axis
T_v = aileron.T(x)                # Compute the torque
